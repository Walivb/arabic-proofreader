/*!
 * ============================================================================
 *  Arabic Proofreader V18.0.0 PRO-MODULAR — Blogger Standalone Bundle
 *  ملف جاهز للنشر (Deployment-Ready) — بدون أي تبعيات خارجية
 * ============================================================================
 *
 *  الإصدار : 18.0.0 (PRO-MODULAR)
 *  التاريخ : 2026-08-12
...
const WORDS = Object.freeze({
  ...
  'مساله': 'مسألة', 'شيئ': 'شيء', 'مدرسه': 'مدرسة', 'المدرسه': 'المدرسة', 'جامعه': 'جامعة',
  'مكتبه': 'مكتبة', 'سياره': 'سيارة', 'شجره': 'شجرة', 'مدينه': 'مدينة',
  'معلومه': 'معلومة', 'مشكله': 'مشكلة', 'فكره': 'فكرة', 'كلمه': 'كلمة',
  'جمله': 'جملة', 'لغه': 'لغة', 'حياه': 'حياة', 'دراسه': 'دراسة',
  'عمليه': 'عملية', 'ضروره': 'ضرورة', 'نتيجه': 'نتيجة', 'بدايه': 'بداية',
  'نهايه': 'نهاية', 'هاذا': 'هذا', 'هاذه': 'هذه', 'هولاء': 'هؤلاء',
    ...
    while ((index = context.text.indexOf(item.bad, index)) >= 0) {
      if (boundary(context.text, index, item.bad.length)) {
        candidates.push(findingFromTextSpan(context, {
          ...
          explanation: item.phrase ? 'تصحيح عبارة إملائية مراجعة مع أولوية للتطابق الأطول.' : 'تصحيح إملائي معجمي مراجع.',
          evidence: [item.phrase ? 'phrase-priority' : 'reviewed-word-lexicon'],
          safe: true
        }));
      }
